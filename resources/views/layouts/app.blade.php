                ...
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('frontend.index') }}" class="d-flex align-items-center text-decoration-none gap-2">
                            <span class="kt-logo-mark d-inline-flex align-items-center justify-content-center">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown me-1">
                                    ...
                                    <a class="nav-link active dropdown-toggle text-gray-700 me-3"
                                        href="#"
                            ...
                            @if ($whisperlyUser)
                                ...
                                <div class="dropdown">
                                    ...
                                    {{-- ADMIN KE PROFIL ADMIN, USER/TALENT TETAP KE PROFIL PENGGUNA --}}
                                    <a href="{{ request()->routeIs('pengguna.profile')
                                        ? route('pengguna.profile')
                                        : ($whisperlyUser->role === 'admin'
                                            ? route('admin.profile')
                                            : route('pengguna.profile')) }}">
                                        ...
                                        <div class="user-menu d-flex">
                                            ...
                                            <div class="user-name text-end me-3">
                                                ...
                                                <h6 class="mb-0 text-gray-700">
                                                    {{ $whisperlyUser->name ?? $whisperlyUser->username }}
                                                </h6>

                                                <p class="mb-0 text-sm text-gray-700">
                                                    {{ ucfirst($whisperlyUser->role ?? 'User') }}
                                                </p>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end"
                                        ...
                                        <li>
                                            ...
                                            <h6 class="dropdown-header">
                                                Hello, {{ $whisperlyUser->name ?? $whisperlyUser->username }}
                                            </h6>
                                        ...
                                        <li>
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ $whisperlyUser->role === 'admin' ? route('admin.profile') : route('pengguna.profile') }}">
                            ...
                            @else
                                ...
                                <div class="dropdown">
                                    ...
                                    <a href="{{ Auth::guard('whisperly')->user()?->role === 'admin' ? route('admin.profile') : route('whisperly.profile') }}">
