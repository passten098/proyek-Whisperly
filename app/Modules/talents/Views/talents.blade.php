            ...
            <div class="card-body">
                <div class="row align-items-center mb-3 g-2">
                    <div class="col-12 col-md-9">
                        <form action="{{ route('talents.index') }}" method="get">
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>
										{!! button('talents.show','', $item->id) !!}
										{!! button('talents.edit', $title, $item->id) !!}
                                        {!! button('talents.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
