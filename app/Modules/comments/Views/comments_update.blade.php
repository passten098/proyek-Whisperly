    ...
    <section class="section">
        <div class="card kt-form-card">
            ...
            <div class="card-body">
                ...
                <form class="form form-horizontal" action="{{ route('comments.update', $comments->id) }}" method="POST">
                    <div class="form-body">
                        @csrf @method('patch')
                        ...
                        <div class="offset-md-3 ps-2 pt-2 d-flex gap-2">
                            ...
                            <a href="{{ route('comments.index') }}" class="btn btn-outline-secondary">Batal</a>
                        </div>
                  </div>
                </form>
            </div>
